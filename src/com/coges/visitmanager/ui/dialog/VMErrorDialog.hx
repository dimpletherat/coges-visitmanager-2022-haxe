...
/**
	 ...
	 */
class VMErrorDialog extends BaseDialog
{
    ...
    override public function init(skin:DialogSkin):Void
    {
		...
		var tf = _skin.contentFormat.clone();
		tf.color = Colors.RED2;
		_txtMessage.defaultTextFormat = tf;
		...
		var tfTitle = _skin.titleFormat.clone();
		tfTitle.color = Colors.RED2;
		_txtTitle.defaultTextFormat = tfTitle;
        ...
        _btClose = new BaseButton( _skin.closeButtonLabel, _skin.closeButtonFormat, SpriteUtils.createRoundSquare( 140, 30, 6, 6, Colors.RED2 ));
